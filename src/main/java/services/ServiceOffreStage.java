...
public class ServiceOffreStage implements IService<OffreDeStage> {
...
//            ps.setString(6,offreDeStage.getLanguage());
    ...
    public List<OffreDeStage> afficher() throws SQLException {
        ...
        try {
            ...
            while (rs.next()){
                list.add(new OffreDeStage(rs.getString("title"),rs.getString("domaine"), rs.getString("type_offre"),rs.getInt("poste_propose"),rs.getString("experience"),rs.getString("description"),rs.getString("exigence_offre")));
